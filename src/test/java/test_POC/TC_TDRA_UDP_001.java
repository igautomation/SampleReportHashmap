...
import pom_WEB.TDRA_UDP_Login;
import pom_WEB.TDRA_UDP_001;
import utilities.*;
import java.util.HashMap;

public class TC_TDRA_UDP_001 {
    ...
    public ReadData_UDP_TDRA readData_UDP_TDRA_Hasmap;
    public ReadData_UDP_Environment readData_UDP_Environment_Details;
    ...
    private TDRA_UDP_Login var_TDRAlogin;
    private TDRA_UDP_001 var_TDRA_PG_001;
    ...
    @Test
    public void TC_TDRA_UDP_001(String Test_Data_Path, String Environment) throws Exception {
        ...
        readData_UDP_TDRA_Hasmap = new ReadData_UDP_TDRA();
        readData_UDP_Environment_Details = new ReadData_UDP_Environment();

        // Create Local Hash Map for Environment sheet
        map_Environment_Details = readData_UDP_Environment_Details.HashMap_Data_Environment_Details(Environment, Test_Data_Path);
        ...
        for (int i = 1; i <= NoOf_Itration; i++) {
            ...
            map_TDRA_CASES = readData_UDP_TDRA_Hasmap.HashMap_Data_TDRA_CASES (i, Test_Data_Path,
                    "TDRA_CASES");
            ...
            if (map_TDRA_CASES.get("TestCaseNo").equals("TC_TDRA_001")) {
                ...
                //Enter URL
                driver.get(map_Environment_Details.get("TDRA_UDP_URL"));
                ...
                var_TDRAlogin = new TDRA_UDP_Login();
                Thread.sleep(5000);
                // Functional Flow
